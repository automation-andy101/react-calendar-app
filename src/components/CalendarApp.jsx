...
const CalendarApp = () => {
    ...
    const [currentMonth, steCurrentMonth] = useState(currentDate.getMonth())
    const [currentYear, steCurrentYear] = useState(currentDate.getFullYear())
        ...
        <div className="calendar-app">
            ...
            <div className="events">
                <div className="event-popup">
                    ...
                    <textarea placeholder="Enter Event Test (Maximum 60 Characters)"></textarea>
